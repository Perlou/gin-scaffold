...
项目地址：https://github.com/perlou/gin-scaffold

### 现在开始

```
git clone git@github.com:perlou/gin-scaffold.git
cd gin-scaffold
go mod tidy
```
...
➜  gin-scaffold git:(master) ✗ go run main.go
------------------------------------------------------------------------
...
[GIN-debug] GET    /demo/index               --> github.com/perlou/gin-scaffold/controller.(*Demo).Index-fm (6 handlers)
[GIN-debug] GET    /demo/bind                --> github.com/perlou/gin-scaffold/controller.(*Demo).Bind-fm (6 handlers)
[GIN-debug] GET    /demo/dao                 --> github.com/perlou/gin-scaffold/controller.(*Demo).Dao-fm (6 handlers)
[GIN-debug] GET    /demo/redis               --> github.com/perlou/gin-scaffold/controller.(*Demo).Redis-fm (6 handlers)
...
[INFO][2019-06-16T11:39:26.802][log.go:58] _com_mysql_success||affected_row=1||traceid=c0a8fe445d05b9ee07b80f9f66cb39b0||spanid=9dad47aa1408d2ac||source=/Users/niuyufu/go/src/github.com/perlou/gin_scaffold/dao/demo.go:24||proc_time=0.000000000||sql=SELECT * FROM `area`  WHERE (id = '1')||level=sql||current_time=2019-06-16 11:39:26||cspanid=
...
参考文档：https://github.com/perlou/golang_common
